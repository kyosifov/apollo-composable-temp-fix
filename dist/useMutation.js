...
function useMutation(document, options) {
    ...
    loadingTracking_1.trackMutation(loading);
    var error = vue_demi_1.ref(null);
    var called = vue_demi_1.ref(false);
    var doneEvent = useEventHook_1.useEventHook();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        else if (vue_demi_1.isRef(document)) {
                        ...
                        else if (vue_demi_1.isRef(options)) {
